...
echo "Executed $n steps<br/>";
echo "Weights: ", vector_to_str($weights), "<br/>";

// Validate the results
print "<br/>Validating training<br/>";
$correct = 0;
for ($i = 0; $i < $NUM_SAMPLES; $i++) {
...
printf("Correctness = %.0f%%<br/>", $correct/$NUM_SAMPLES*100.0);

// Try some predictions
print "<br/>Testing the model<br/>";
$test = array(
    array(-1., 1.1, 1.),
    array(23., 0.9, 0.),
    array( 4., 1.9, 0.),
...
for ($i = 0; $i < sizeof($test); $i++) {
    ...
    printf("<br/> Input: %-16s predict: %d<br/>", vector_to_str($test[$i]), $predict);
}
